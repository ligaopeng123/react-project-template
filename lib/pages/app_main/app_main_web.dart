...
/// });
/// ```
class AppMainWeb extends StatefulWidget {
  ...
  @override
  State<AppMainWeb> createState() => _AppMainWebState();
...
class _AppMainWebState extends State<AppMainWeb>
  ...
  final List<Map<String, dynamic>> appBottomBar = [
    ...
    //   'switcher_icon': CupertinoIcons.gear_alt_fill,
    //   'body': MyPersonal(),
    // },
    {
      'title': '我的',
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (AppConfig.notSplash &&
          ...
          AppConfig.directPageName != RouteName.appMainWeb) {
  ...
  Widget _scaffoldBody() {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        // 选中的字体大小
        unselectedFontSize: 26.sp,
        // 未选中的字体大小
        onTap: (int idx) async {
          setState(() {
            currentIndex = idx;
          });
          pageController.animateToPage(idx, duration: Duration(milliseconds: 300), curve: Curves.ease); // 跳转
        },
  ...
  List<BottomNavigationBarItem> _generateBottomBars() {
    try {
      return appBottomBar.asMap().entries.map<BottomNavigationBarItem>((item) {
        ...
        return BottomNavigationBarItem(
          icon: AnimatedSwitcher(
            ...
            child: currentIndex == index
                ? Icon(
                    itemData['switcher_icon'] as IconData, // 图标
                    size: 44.sp,
                  )
                : Icon(
