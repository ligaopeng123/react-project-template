...
import {TableList, delTable} from "../api";
import styles from '../styles.module.less';

const TableTable: React.FC<TableProps> = (props) => {
	...
	return (
		<ProTable<TableListItem>
			...
			request={async (params, sorter, filter) => {
				...
				const data = await TableList(newParams);
				return {
					data,
					success: true,
				};
